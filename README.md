...
-  Мета: розпочати кар'єру в Інтернеті, потрапити на позицію **Frontend Developer (Junior)**
-  Люблю реалізовувати дизайн-макети у коді
...
###  Мої проекти, усі макети шукав в інтернеті
